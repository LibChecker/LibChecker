...
import com.absinthe.libchecker.view.detail.PermissionInfoBottomSheetView
...
class PermissionDetailDialogFragment :
  ...
  private val origPermName by lazy { arguments?.getString(EXTRA_ORIG_PERM_NAME).orEmpty() }
