...
abstract class LCDatabase : RoomDatabase() {
  ...
  companion object {
    const val DATABASE_NAME = "lc_database"
    ...
    private val MIGRATION_1_2: Migration = object : Migration(1, 2) {
      override suspend fun migrate(connection: SQLiteConnection) {
        connection.execSQL("DROP TABLE IF EXISTS native_lib_table")
        connection.execSQL(
    ...
    private val MIGRATION_6_7: Migration = object : Migration(6, 7) {
      override suspend fun migrate(connection: SQLiteConnection) {
        ...
        connection.execSQL("DROP TABLE snapshot_table")
        // Change the table name to the correct one
        connection.execSQL("ALTER TABLE snapshot_new RENAME TO snapshot_table")
      }
    }
    ...
    private val MIGRATION_12_13: Migration = object : Migration(12, 13) {
      override suspend fun migrate(connection: SQLiteConnection) {
        ...
        // Remove the old table
        connection.execSQL("DROP TABLE rules_table")
        // Change the table name to the correct one
        connection.execSQL("ALTER TABLE rules_new RENAME TO rules_table")
      }
    }
    ...
    private val MIGRATION_14_15: Migration = object : Migration(14, 15) {
      override suspend fun migrate(connection: SQLiteConnection) {
        connection.execSQL("ALTER TABLE timestamp_table ADD COLUMN topApps TEXT")
      }
    }
    ...
    private val MIGRATION_17_18: Migration = object : Migration(17, 18) {
      override suspend fun migrate(connection: SQLiteConnection) {
        ...
        // Remove the old table
        connection.execSQL("DROP TABLE item_table")
        // Change the table name to the correct one
        connection.execSQL("ALTER TABLE item_table_new RENAME TO item_table")
      }
    }
    ...
    private val MIGRATION_18_19: Migration = object : Migration(18, 19) {
      override suspend fun migrate(connection: SQLiteConnection) {
        ...
        connection.execSQL("DELETE FROM diff_table")
      }
    }
    ...
    private val MIGRATION_22_23: Migration = object : Migration(22, 23) {
      override suspend fun migrate(connection: SQLiteConnection) {
        connection.execSQL(
          "ALTER TABLE snapshot_table ADD COLUMN isArchived INTEGER NOT NULL DEFAULT 0"
        )
        connection.execSQL(
          "ALTER TABLE diff_table ADD COLUMN isArchived INTEGER NOT NULL DEFAULT 0"
        )
      }
    }
  }
