...
class AppsListLoadingView @JvmOverloads constructor(
  ...
  override fun onDraw(canvas: Canvas) {
    ...
    canvas.drawRect(drawBounds, clearPaint)
  ...
  private fun applyRotationMatrix() {
    ...
    val shift = (phase * bitmap.width).roundToInt().toFloat()
  ...
  private fun Paint.setEraseBlendCompat() {
  ...
  private fun Paint.setClearCompat() {
    if (Build.VERSION.SDK_INT >= 29) {
      xfermode = null
