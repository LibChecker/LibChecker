...
class ComparisonDashboardHalfView(context: Context, attributeSet: AttributeSet) : AViewGroup(context, attributeSet) {
    ...
    override fun onLayout(changed: Boolean, l: Int, t: Int, r: Int, b: Int) {
        tvSnapshotTimestampTitle.layout(paddingStart, paddingTop, fromRight = horizontalGravity == Gravity.END)
        tvSnapshotTimestampText.layout(tvSnapshotTimestampTitle.left, tvSnapshotTimestampTitle.bottom, fromRight = horizontalGravity == Gravity.END)
        tvSnapshotAppsCountTitle.layout(tvSnapshotTimestampTitle.left, tvSnapshotTimestampText.bottom + tvSnapshotAppsCountTitle.marginTop, fromRight = horizontalGravity == Gravity.END)
        tvSnapshotAppsCountText.layout(tvSnapshotTimestampTitle.left, tvSnapshotAppsCountTitle.bottom, fromRight = horizontalGravity == Gravity.END)
    }
}
